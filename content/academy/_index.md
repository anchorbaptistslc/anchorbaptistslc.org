...
description: K4-12th grade Christian education in Salt Lake City
type: academy
layout: single
hero:
  title: Anchor Baptist Academy
...
sections:
  about:
    ...
    subsections:
      - title: Our Mission
        content: Our mission is to provide quality Christian education that develops
          students spiritually, academically, physically, and socially. We seek
          to prepare children to impact their world for Christ.
      - title: Our History
    ...
    features:
      ...
      - title: Small Class Sizes
        description: Our low student-to-teacher ratio ensures personalized attention and
          allows teachers to meet the individual needs of each student.
        icon: users
      - title: Experienced Teachers
        description: Our qualified, caring teachers are dedicated to academic excellence
          and the spiritual development of every child.
        icon: graduation-cap
  admissions:
    ...
    steps:
      ...
      - number: 3
        ...
        description: We'll meet with your family to discuss your child's educational
          needs and ensure our academy is a good fit.
      - number: 4
        title: Enrollment
        description: Upon acceptance, complete the enrollment paperwork and submit the
  ...
  policies:
    ...
    documents:
      - title: 2026-2027 Student Handbook
        file: /files/uploads/aba_student_handbook_2026-2027.pdf
  contact:
    title: Contact Us
